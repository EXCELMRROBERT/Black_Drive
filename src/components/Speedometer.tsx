...
export default function Speedometer({
  ...
  return (
    <div 
      id="gauge_panel" 
      className="relative flex items-center justify-center w-full max-w-[420px] mx-auto select-none mt-1 sm:mt-2 px-1 scale-[1.02] min-[360px]:scale-[1.10] min-[400px]:scale-[1.15] sm:scale-[1.25] md:scale-[1.35] landscape:scale-90 landscape:min-[700px]:scale-[1.05] landscape:min-[800px]:scale-[1.15] landscape:md:scale-100 origin-center transition-transform duration-300"
    >
